...
const waveMaxY = SCREEN_HEIGHT - 200; // Fixed bottom position
const minYRange = [SCREEN_HEIGHT - 120, SCREEN_HEIGHT - 120]; // Range for random minY values

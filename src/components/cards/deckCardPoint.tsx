...
import {DiscardedPointer, DiscardPointer, PickupPointer} from './discardPoint';
          ...
          style={[
            styles.body,
            {
              transform: [
                {
                  translateX:
                    -((layerHistory.layer3.length - 1) * CARD_WIDTH) / 2,
                },
              ],
            },
          ]}
          ...
          style={[
            styles.body,
            {
              transform: [
                {
                  translateX:
                    -((layerHistory.layer2.length - 1) * CARD_WIDTH) / 2,
                },
              ],
            },
          ]}
          ...
          style={[
            styles.body,
            {
              transform: [
                {
                  translateX:
                    -((layerHistory.layer1.length - 1) * CARD_WIDTH) / 2,
                },
              ],
            },
          ]}>
